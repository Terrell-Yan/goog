...
import com.example.goog.utils.SPHelper;
...
private String  strFilePath;
    ...
    public static PageFactory getInstance(PageView view,String url){
        if(instance == null){
            synchronized (PageFactory.class){
                if(instance == null){
                    instance = new PageFactory(view);
                    instance.openBook(url);
                }
            }
        }
        return instance;
    ...
    private void openBook(String strFilePath){
