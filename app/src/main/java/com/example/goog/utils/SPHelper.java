...
public class SPHelper {
    private SharedPreferences config = BaseApp.getGlobalContext().getSharedPreferences("config", Context.MODE_PRIVATE);
    private SharedPreferences.Editor configEditor = config.edit();
    private SharedPreferences bookmark = BaseApp.getGlobalContext().getSharedPreferences("bookmark", Context.MODE_PRIVATE);
    ...
    public String getBookEncoding(Book_item book){
        return config.getString(book.book_url,"");
    }
    public void setBookEncoding(Book_item book,String encoding){
        configEditor.putString(book.book_url,encoding).apply();
    }
